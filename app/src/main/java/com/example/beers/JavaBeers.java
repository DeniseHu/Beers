...
public class JavaBeers {
    ...
    public JavaBeers(String id, String name, String shortDescription, String description, double abv, int ibuMin, int ibuMax, int srmMin, int srmMax, String brewery) {
        this.id = id;
        this.name = name;
